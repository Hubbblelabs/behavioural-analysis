            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex items-center justify-center px-4">
                <Card className="max-w-md w-full border-0 shadow-2xl">
                    <CardContent className="p-8 text-center">
                        <div className="mb-6 mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 text-4xl shadow-lg shadow-emerald-500/30">
                            ✓
                        </div>
                        ...
                        <div className="flex flex-col gap-3">
                            <Button
                                ...
                                className="w-full rounded-full bg-gradient-to-r from-indigo-600 to-purple-600 py-6 text-lg font-semibold shadow-lg"
                            >
                                View My Results
                            </Button>
                            <Button
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none">
                <div className="absolute -top-40 -right-40 h-80 w-80 rounded-full bg-gradient-to-br from-indigo-500/10 to-purple-500/10 blur-3xl" />
                <div className="absolute bottom-0 -left-40 h-80 w-80 rounded-full bg-gradient-to-br from-emerald-500/10 to-teal-500/10 blur-3xl" />
            </div>
            ...
            <main className="relative z-10 mx-auto max-w-4xl px-6 py-8">
                ...
                >
                    <CardHeader className="pb-4">
                        ...
                        <CardTitle className="text-xl md:text-2xl font-bold text-slate-900 dark:text-white leading-tight">
                            {question.text}
                        </CardTitle>
                    </CardHeader>
                    ...
                    <CardContent>
                        ...
                        >
                            {question.options.map((option, index) => (
                                <RadioGroupItem
                                    key={index}
                                    value={option.type}
                                    className={`transition-all duration-200 ${selectedOption === option.type
                        ...
                        <div className="flex justify-between items-center mt-8 pt-6 border-t border-slate-200 dark:border-slate-800">
                            ...
                            <Button
                                onClick={handleNext}
                                disabled={!canProceed}
                                className="gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 shadow-lg disabled:opacity-50"
                            >
                ...
                <div className="mt-6 text-center">
                    <p className="text-sm text-slate-500 dark:text-slate-500">
                        💡 Tip: Choose the option that best describes your natural tendency, not what you think is &quot;correct&quot;
                    </p>
                </div>
                        ...
                        <div className="mt-4 grid grid-cols-10 gap-2">
                            {discQuestions.map((q, idx) => (
                                <button
                                    ...
                                    className={`h-8 w-8 rounded-lg text-xs font-medium transition-all ${idx === currentQuestion
